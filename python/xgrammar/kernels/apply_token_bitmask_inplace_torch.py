...
def apply_token_bitmask_inplace_kernel_no_indices_torch(
...
def apply_token_bitmask_inplace_kernel_indices_torch(
...
def apply_token_bitmask_inplace_torch(
    ...
    if indices is None:
        apply_token_bitmask_inplace_kernel_no_indices_torch(logits, bitmask, vocab_size)
    else:
        apply_token_bitmask_inplace_kernel_indices_torch(
