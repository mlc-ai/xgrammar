...
class GrammarMatcher(XGObject):
    ...
    def accept_token(self, token_id: int, *, debug_print: bool = False) -> bool:
        ...
        """
        return self.handle.accept_token(token_id, debug_print)
    ...
    def accept_string(self, input_str: Union[str, bytes], *, debug_print: bool = False) -> bool:
        ...
        """
        return self.handle.accept_string(input_str, debug_print)
    ...
    def fill_next_token_bitmask(self, bitmask: torch.Tensor, index: int = 0) -> None:
        ...
        """
        self.handle.fill_next_token_bitmask(bitmask, index)
    ...
    def apply_token_bitmask_inplace(
        ...
        *,
        ...
        _core.GrammarMatcher.apply_token_bitmask_inplace(logits, bitmask, indices)

    def debug_get_masked_tokens_from_bitmask(
        self, bitmask: torch.Tensor, index: int = 0
    ) -> List[int]:
        ...
        """
        return self.handle.debug_get_masked_tokens_from_bitmask(bitmask, index)
