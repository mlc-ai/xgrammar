...
string_test_schemas = [
    ...
    {"type": "string", "minLength": 10, "maxLength": 2048},
    {"type": "string"},
]

array_test_schemas = [
    {"type": "array", "items": {"type": ["string", "number"]}, "minItems": 10},
    {"type": "array", "items": {"type": ["string", "number"]}, "maxItems": 2048},
    {"type": "array", "items": {"type": ["string", "number"]}, "minItems": 10, "maxItems": 2048},
...
object_test_schemas = [
    ...
    {"type": "object", "patternProperties": {"^[a-zA-Z_][a-zA-Z_0-9]*$": {"type": "string"}}},
]
...
def test_schema_length(schemas: list[dict], lengths: list[int]):
    for length in lengths:
        ...
        for schema in schemas:
            ...
            print(
                f"Schema: {schema}, String Length: {length}, Compile Time: {compile_time / 1000:.2f} us"
            )
            ...
            print(
                f"Schema: {schema}, String Length: {length}, Average TPoT: {avg_tpot / 1000:.2f} us"
            )
...
def test_array_length(schemas: list[dict], lengths: list[int]):
    for length in lengths:
        ...
        for schema in schemas:
            ...
            compile_time = time.monotonic_ns() - start_time
            print(
                f"Schema: {schema}, Array Length: {length}, Compile Time: {compile_time / 1000:.2f} us"
            )
            ...
            avg_tpot = sum(tpots) / len(tpots)
            print(
                f"Schema: {schema}, Array Length: {length}, Average TPoT: {avg_tpot / 1000:.2f} us"
            )
...
def test_object_length(schemas: list[dict], lengths: list[int]):
    for length in lengths:
        ...
        for schema in schemas:
            ...
            compile_time = time.monotonic_ns() - start_time
            print(
                f"Schema: {schema}, Object Length: {length}, Compile Time: {compile_time / 1000:.2f} us"
            )
            ...
            avg_tpot = sum(tpots) / len(tpots)
            print(
                f"Schema: {schema}, Object Length: {length}, Average TPoT: {avg_tpot / 1000:.2f} us"
            )
