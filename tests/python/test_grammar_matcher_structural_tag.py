...
expected_grammar_test_structural_tag_after_optimization = r"""basic_escape ::= (([\"\\/bfnrt]) | ("u" [A-Fa-f0-9] [A-Fa-f0-9] [A-Fa-f0-9] [A-Fa-f0-9])) (=(basic_string_sub root_part_0 [ \n\t]* "}"))
...
basic_number_1_1 ::= ("" | ("-")) (=(basic_number_7_1 basic_number_3_1 basic_number_6_1 root_part_0_1 [ \n\t]* "}" "</function>"))
basic_number_2_1 ::= (([0-9] basic_number_2_1) | ([0-9])) (=(basic_number_6_1 root_part_0_1 [ \n\t]* "}" "</function>"))
basic_number_3_1 ::= ("" | ("." basic_number_2_1)) (=(basic_number_6_1 root_part_0_1 [ \n\t]* "}" "</function>"))
basic_number_4_1 ::= ("" | ([+\-])) (=(basic_number_5_1 root_part_0_1 [ \n\t]* "}" "</function>"))
basic_number_5_1 ::= (([0-9] basic_number_5_1) | ([0-9])) (=(root_part_0_1 [ \n\t]* "}" "</function>"))
basic_number_6_1 ::= ("" | ([eE] basic_number_4_1 basic_number_5_1)) (=(root_part_0_1 [ \n\t]* "}" "</function>"))
root_prop_1_1 ::= ("" | ([ \n\t]* "," [ \n\t]* basic_string_1 root_prop_1_1)) (=([ \n\t]* "]" [ \n\t]* "}" "</function>"))
basic_number_7_1 ::= (("0") | ([1-9] [0-9]*)) (=(basic_number_3_1 basic_number_6_1 root_part_0_1 [ \n\t]* "}" "</function>"))
