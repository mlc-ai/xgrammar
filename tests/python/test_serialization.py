...
def test_serialize_grammar():
    ...
    expected_json = {
        "rules": [
            ["rule1", 4, -1, False, -1, "", 0, 0, -1, -1, "", False],
            ["root", 8, -1, False, -1, "", 0, 0, -1, -1, "", False],
        ],
...
def test_serialize_grammar_exception():
    ...
    expected_json = {
        "rules": [
            ["rule1", 4, 9, True, -1, "", 0, 0, -1, -1, "", False],
            ["root", 8, -1, False, -1, "", 0, 0, -1, -1, "", False],
        ],
    ...
    expected_json["__VERSION__"] = "v15"  # The previous rule layout must fail by version first.
