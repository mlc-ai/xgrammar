...
"""
    ...
    expected = r"""root ::= (("{" [ \n\t]{0,20} members_and_embrace) | ("[" [ \n\t]{0,20} elements_or_embrace))
value_non_str ::= (("{" [ \n\t]{0,20} members_and_embrace) | ("[" [ \n\t]{0,20} elements_or_embrace) | ("0" fraction exponent) | ([1-9] [0-9]* fraction exponent) | ("-" [0-9] fraction exponent) | ("-" [1-9] [0-9]* fraction exponent) | ("true") | ("false") | ("null")) (=([ \n\t,}\]]))
members_and_embrace ::= (("\"" characters_and_colon [ \n\t]{0,20} members_suffix) | ("}")) (=([ \n\t,}\]]))
members_suffix ::= ((value_non_str [ \n\t]{0,20} member_suffix_suffix) | ("\"" characters_and_embrace) | ("\"" characters_and_comma [ \n\t]{0,20} "\"" characters_and_colon [ \n\t]{0,20} members_suffix)) (=([ \n\t,}\]]))
member_suffix_suffix ::= (("}") | ("," [ \n\t]{0,20} "\"" characters_and_colon [ \n\t]{0,20} members_suffix)) (=([ \n\t,}\]]))
elements_or_embrace ::= (("{" [ \n\t]{0,20} members_and_embrace elements_rest [ \n\t]{0,20} "]") | ("[" [ \n\t]{0,20} elements_or_embrace elements_rest [ \n\t]{0,20} "]") | ("\"" characters_item elements_rest [ \n\t]{0,20} "]") | ("0" fraction exponent elements_rest [ \n\t]{0,20} "]") | ([1-9] [0-9]* fraction exponent elements_rest [ \n\t]{0,20} "]") | ("-0" fraction exponent elements_rest [ \n\t]{0,20} "]") | ("-" [1-9] [0-9]* fraction exponent elements_rest [ \n\t]{0,20} "]") | ("true" elements_rest [ \n\t]{0,20} "]") | ("false" elements_rest [ \n\t]{0,20} "]") | ("null" elements_rest [ \n\t]{0,20} "]") | ("]"))
elements ::= (("{" [ \n\t]{0,20} members_and_embrace elements_rest) | ("[" [ \n\t]{0,20} elements_or_embrace elements_rest) | ("\"" characters_item elements_rest) | ("0" fraction exponent elements_rest) | ([1-9] [0-9]* fraction exponent elements_rest) | ("-" [0-9] fraction exponent elements_rest) | ("-" [1-9] [0-9]* fraction exponent elements_rest) | ("true" elements_rest) | ("false" elements_rest) | ("null" elements_rest))
elements_rest ::= ("" | ([ \n\t]{0,20} "," [ \n\t]{0,20} elements))
characters_and_colon ::= (("\"" [ \n\t]{0,20} ":") | ([^\"\\\0-\x1f] characters_and_colon) | ("\\" escape characters_and_colon)) (=([ \n\t]{0,20} [\"{[0-9tfn\-]))
characters_and_comma ::= (("\"" [ \n\t]{0,20} ",") | ([^\"\\\0-\x1f] characters_and_comma) | ("\\" escape characters_and_comma)) (=([ \n\t]{0,20} "\""))
characters_and_embrace ::= (("\"" [ \n\t]{0,20} "}") | ([^\"\\\0-\x1f] characters_and_embrace) | ("\\" escape characters_and_embrace)) (=([ \n\t]{0,20} [},]))
