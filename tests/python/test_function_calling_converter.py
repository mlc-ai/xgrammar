...
root ::= ( [ \n\t]* (("<parameter=name>" [ \n\t]* root_prop_0 [ \n\t]* "</parameter>" root_part_0) | ("<parameter=age>" [ \n\t]* basic_integer [ \n\t]* "</parameter>" root_part_1) | "<parameter=" xml_string ">" [ \n\t]* root_addl [ \n\t]* "</parameter>" root_part_1) [ \n\t]*) | [ \n\t]*
"""
...
test_inner_object_schema_input_str_accepted = (
    ...
    (
        '<parameter=address>{"street": "Main St", "city": "New York", "additional_property": "value"}</parameter><parameter=additional_property>value</parameter>',
        True,
    ),
    (
        '<parameter=address>{"street": "Main St", "city": "New York", "additional_property": value}</parameter>',
        False,
    ),
)
...
xml_string ::= TagDispatch(stop_eos=true,stop_str=(),loop_after_dispatch=false,excludes=("</parameter>"))
xml_any ::= basic_number | xml_string | basic_boolean | basic_null | basic_array | basic_object
root_prop_0_prop_0 ::= ["] basic_string_sub
root_prop_0_prop_1 ::= ["] basic_string_sub
root_prop_0_addl ::= basic_number | basic_string | basic_boolean | basic_null | basic_array | basic_object
root_prop_0_part_1 ::= ([ \n\t]* "," [ \n\t]* basic_string [ \n\t]* ":" [ \n\t]* root_prop_0_addl)*
root_prop_0_part_0 ::= [ \n\t]* "," [ \n\t]* "\"city\"" [ \n\t]* ":" [ \n\t]* root_prop_0_prop_1 root_prop_0_part_1
root_prop_0 ::= "{" [ \n\t]* (("\"street\"" [ \n\t]* ":" [ \n\t]* root_prop_0_prop_0 root_prop_0_part_0)) [ \n\t]* "}"
root_addl ::= basic_number | xml_string | basic_boolean | basic_null | basic_array | basic_object
root_part_0 ::= ([ \n\t]* "<parameter=" xml_string ">" [ \n\t]* root_addl [ \n\t]* "</parameter>")*
root ::=  [ \n\t]* (("<parameter=address>" [ \n\t]* root_prop_0 [ \n\t]* "</parameter>" root_part_0)) [ \n\t]*
"""
...
"""
    ...
    _check_minimax_grammar(ebnf_grammar, expected_grammar, input_str, accepted)
...
minimax_test_additional_properties_schema_input_str_accepted = (
    ...
    (
        '<parameter name="name">Bob</parameter><parameter name="age">100</parameter><parameter name="123456">A</parameter>',
        True,
    ),
)
...
root_part_1 ::= ([ \n\t]* "<parameter name=\"" xml_string "\">" [ \n\t]* root_addl [ \n\t]* "</parameter>")*
root_part_0 ::= root_part_1 | [ \n\t]* "<parameter name=\"age\">" [ \n\t]* basic_integer [ \n\t]* "</parameter>" root_part_1
root ::= ( [ \n\t]* (("<parameter name=\"name\">" [ \n\t]* root_prop_0 [ \n\t]* "</parameter>" root_part_0) | ("<parameter name=\"age\">" [ \n\t]* basic_integer [ \n\t]* "</parameter>" root_part_1) | "<parameter name=\"" xml_string "\">" [ \n\t]* root_addl [ \n\t]* "</parameter>" root_part_1) [ \n\t]*) | [ \n\t]*
"""
    schema = {
        "type": "object",
        "properties": {"name": {"type": "string"}, "age": {"type": "integer"}},
...
minimax_test_numbers_schema_input_str_accepted = (
    ...
    ('<parameter name="name">Bob</parameter>\n<parameter name="age">25</parameter>', True),
    (
...
basic_null ::= "null"
basic_array ::= (("[" [ \n\t]* basic_any ([ \n\t]* "," [ \n\t]* basic_any)* [ \n\t]* "]") | ("[" [ \n\t]* "]"))
basic_object ::= ( [ \n\t]* "<{dsml_token}parameter name=\"" xml_string "\" string=\"" ("true" | "false") "\">" [ \n\t]* basic_any [ \n\t]* "</{dsml_token}parameter>" ([ \n\t]* "<{dsml_token}parameter name=\"" xml_string "\" string=\"" ("true" | "false") "\">" [ \n\t]* basic_any [ \n\t]* "</{dsml_token}parameter>")* [ \n\t]*) | [ \n\t]*
xml_string ::= TagDispatch(stop_eos=true,stop_str=(),loop_after_dispatch=false,excludes=("</{dsml_token}parameter>"))
xml_any ::= basic_number | xml_string | basic_boolean | basic_null | basic_array | basic_object
root_prop_0 ::= xml_string
root_part_0 ::= [ \n\t]* "<{dsml_token}parameter name=\"age\" string=\"" ("true" | "false") "\">" [ \n\t]* basic_integer [ \n\t]* "</{dsml_token}parameter>" ""
root ::=  [ \n\t]* (("<{dsml_token}parameter name=\"name\" string=\"" ("true" | "false") "\">" [ \n\t]* root_prop_0 [ \n\t]* "</{dsml_token}parameter>" root_part_0)) [ \n\t]*
"""
    schema = {
        "type": "object",
        "properties": {"name": {"type": "string"}, "age": {"type": "integer"}},
    ...
    _check_deepseek_grammar(ebnf_grammar, expected_grammar, input_str, accepted)
...
deepseek_test_additional_properties_schema_input_str_accepted = (
    ...
    (
        '<{dsml_token}parameter name="name" string="true">Bob</{dsml_token}parameter><{dsml_token}parameter name="age" string="true">100</{dsml_token}parameter><{dsml_token}parameter name="123456" string="false">A</{dsml_token}parameter>',
        True,
    ),
    (
...
root_part_1 ::= ([ \n\t]* "<{dsml_token}parameter name=\"" xml_string "\" string=\"" ("true" | "false") "\">" [ \n\t]* root_addl [ \n\t]* "</{dsml_token}parameter>")*
root_part_0 ::= root_part_1 | [ \n\t]* "<{dsml_token}parameter name=\"age\" string=\"" ("true" | "false") "\">" [ \n\t]* basic_integer [ \n\t]* "</{dsml_token}parameter>" root_part_1
root ::= ( [ \n\t]* (("<{dsml_token}parameter name=\"name\" string=\"" ("true" | "false") "\">" [ \n\t]* root_prop_0 [ \n\t]* "</{dsml_token}parameter>" root_part_0) | ("<{dsml_token}parameter name=\"age\" string=\"" ("true" | "false") "\">" [ \n\t]* basic_integer [ \n\t]* "</{dsml_token}parameter>" root_part_1) | "<{dsml_token}parameter name=\"" xml_string "\" string=\"" ("true" | "false") "\">" [ \n\t]* root_addl [ \n\t]* "</{dsml_token}parameter>" root_part_1) [ \n\t]*) | [ \n\t]*
"""
    schema = {
        "type": "object",
        "properties": {"name": {"type": "string"}, "age": {"type": "integer"}},
...
root_addl ::= basic_number | xml_string | basic_boolean | basic_null | basic_array | basic_object
root_part_0 ::= ([ \n\t]* "<{dsml_token}parameter name=\"" xml_string "\" string=\"" ("true" | "false") "\">" [ \n\t]* root_addl [ \n\t]* "</{dsml_token}parameter>")*
root ::=  [ \n\t]* (("<{dsml_token}parameter name=\"address\" string=\"" ("true" | "false") "\">" [ \n\t]* root_prop_0 [ \n\t]* "</{dsml_token}parameter>" root_part_0)) [ \n\t]*
"""
    schema = {
        "type": "object",
        "properties": {
...
deepseek_test_numbers_schema_input_str_accepted = (
    ...
    (
        '<{dsml_token}parameter name="name" string="true">Bob</{dsml_token}parameter>\n<{dsml_token}parameter name="age" string="false">25</{dsml_token}parameter>',
        True,
    ),
    (
...
xml_any ::= basic_number | xml_string | basic_boolean | basic_null | basic_array | basic_object
root_prop_0 ::= xml_string
root_part_2_1 ::= [ \n\t]* "<{dsml_token}parameter name=\"is_student\" string=\"" ("true" | "false") "\">" [ \n\t]* basic_boolean [ \n\t]* "</{dsml_token}parameter>" ""
root_part_2_2 ::= "" | [ \n\t]* "<{dsml_token}parameter name=\"is_student\" string=\"" ("true" | "false") "\">" [ \n\t]* basic_boolean [ \n\t]* "</{dsml_token}parameter>" ""
root_part_2_3 ::= ""
root_part_1_1 ::= root_part_2_1 | [ \n\t]* "<{dsml_token}parameter name=\"ID\" string=\"" ("true" | "false") "\">" [ \n\t]* basic_integer [ \n\t]* "</{dsml_token}parameter>" root_part_2_2
