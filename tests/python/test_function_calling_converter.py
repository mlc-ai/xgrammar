...
xml_object ::= (([ \n\t]* xml_object_1 xml_object_properties{0, -1} [ \n\t]*) | ([ \n\t]*))
xml_variable_name ::= (([a-zA-Z_] [a-zA-Z0-9_]*))
basic_number_digits ::= (([0-9]))
basic_array_items ::= (([ \n\t]* "," [ \n\t]* basic_any))
basic_object_properties ::= (([ \n\t]* "," [ \n\t]* basic_string [ \n\t]* ":" [ \n\t]* basic_any))
xml_object_properties ::= (([ \n\t]* xml_object_properties_1))
root ::= (([ \n\t]* "<\uff5cDSML\uff5cparameter name=\"name\" string=\"true\">" xml_string "</\uff5cDSML\uff5cparameter>" root_part_0 [ \n\t]*))
root_part_0 ::= (([ \n\t]* "<\uff5cDSML\uff5cparameter name=\"age\" string=\"false\">" [ \n\t]* basic_integer [ \n\t]* "</\uff5cDSML\uff5cparameter>"))
basic_integer_1 ::= ("" | ("-"))
basic_number_1 ::= ("" | ("-"))
...
basic_object_properties ::= (([ \n\t]* "," [ \n\t]* basic_string [ \n\t]* ":" [ \n\t]* basic_any))
xml_object_properties ::= (([ \n\t]* xml_object_properties_1))
root ::= (([ \n\t]* "<\uff5cDSML\uff5cparameter name=\"url\" string=\"true\">" root_string_prop_0 "</\uff5cDSML\uff5cparameter>" [ \n\t]*))
...
basic_object_properties ::= (([ \n\t]* "," [ \n\t]* basic_string [ \n\t]* ":" [ \n\t]* basic_any))
xml_object_properties ::= (([ \n\t]* xml_object_properties_1))
root ::= (([ \n\t]* "<\uff5cDSML\uff5cparameter name=\"address\" string=\"false\">" [ \n\t]* root_json_prop_0 [ \n\t]* "</\uff5cDSML\uff5cparameter>" root_part_0 [ \n\t]*))
...
xml_object_properties ::= (([ \n\t]* xml_object_properties_1))
root ::= (([ \n\t]* root_1 [ \n\t]*))
root_part_2_1 ::= (([ \n\t]* "<\uff5cDSML\uff5cparameter name=\"is_student\" string=\"false\">" [ \n\t]* basic_boolean [ \n\t]* "</\uff5cDSML\uff5cparameter>"))
root_part_2_2 ::= ("" | ([ \n\t]* "<\uff5cDSML\uff5cparameter name=\"is_student\" string=\"false\">" [ \n\t]* basic_boolean [ \n\t]* "</\uff5cDSML\uff5cparameter>"))
root_part_2_3 ::= ("")
root_part_1_1 ::= ((root_part_2_1) | ([ \n\t]* "<\uff5cDSML\uff5cparameter name=\"ID\" string=\"false\">" [ \n\t]* basic_integer [ \n\t]* "</\uff5cDSML\uff5cparameter>" root_part_2_2))
...
root_json_prop_0_case_2 ::= (("[" [ \n\t]* basic_string root_json_prop_0_case_2_items{0, -1} [ \n\t]* "]") | ("[" [ \n\t]* "]"))
...
basic_object_properties ::= (([ \n\t]* "," [ \n\t]* basic_string [ \n\t]* ":" [ \n\t]* basic_any))
xml_object_properties ::= (([ \n\t]* xml_object_properties_1))
root ::= (([ \n\t]* "<\uff5cDSML\uff5cparameter name=\"string1\" string=\"true\">" root_string_prop_0 "</\uff5cDSML\uff5cparameter>" root_part_0 [ \n\t]*))
defs_String ::= ((xml_string))
root_string_prop_0 ::= ((defs_String))
root_string_prop_1 ::= ((defs_String))
root_part_0 ::= (([ \n\t]* "<\uff5cDSML\uff5cparameter name=\"string2\" string=\"true\">" root_string_prop_1 "</\uff5cDSML\uff5cparameter>"))
basic_integer_1 ::= ("" | ("-"))
basic_number_1 ::= ("" | ("-"))
basic_number_2 ::= (("0") | ([1-9] [0-9]*))
basic_number_3 ::= ("" | ("." basic_number_digits{1, -1}))
