...
//    * \return A Format object if the JSON is valid, otherwise an error message in
//    std::runtime_error.
...
// Result<WildcardTextFormat> StructuralTagImpl::ParseWildcardTextFormat(const picojson::object&
// obj) {
...
// Result<TriggeredTagsFormat> StructuralTagImpl::ParseTriggeredTagsFormat(const picojson::object&
// obj ) {
...
//   Result<STIIR::WildcardTextFormatInternal> VisitWildcardTextFormat(const WildcardTextFormat&
//   format
//   );
...
// Result<STIIR::LiteralFormatInternal> STIIRConverter::VisitLiteralFormat(const LiteralFormat&
// format ) {
...
//   std::optional<std::runtime_error> VisitTriggeredTagsFormat(TriggeredTagsFormatInternal*
//   format); std::optional<std::runtime_error> VisitTagsWithSeparatorFormat(
...
// std::optional<std::runtime_error> StructuralTagAnalyzer::VisitTagFormat(TagFormatInternal*
// format) {
...
// Result<int32_t> StructuralTagInternalToGrammarConverter::VisitFormat(const FormatInternal&
// format) {
//   return std::visit(
