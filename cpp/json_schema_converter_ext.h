...
class XMLToolCallingConverter : public JSONSchemaConverter {
 ...
 protected:
  // Override generation methods for XML format.
  ...
  int32_t GenerateObject(
      const ObjectSpec& spec, const std::string& rule_name, bool need_braces = false
  ) override;
