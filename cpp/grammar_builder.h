...
class GrammarBuilder {
 public:
  ...
  /*! \brief Set hard decoded-character bounds for a generated JSON string rule. */
  void UpdateJSONStringLength(int32_t rule_id, int32_t min_length, int32_t max_length);
